...
class CoucheNeurones:
    ...
    def forward(self, X):
        ...
        self.last_input = X #stock entrée
        self.last_z = np.add (np.dot (self.weights, X), self.bias)  # Combinaison linéaire
        self.last_activation = self.activation_func(self.last_z)  # Après fonction d'activation
